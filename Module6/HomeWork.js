...
class Hamburger {
  ...
  removeTopping(topping) {
    return this._toppings = this._toppings.filter(i => i !== topping);
  }
   ...
   */
  get calculatePrice() {
    let price = this._toppings.map(i => Hamburger.TOPPINGS[i].price);
    price.push(Hamburger.SIZES[this._size].price, Hamburger.STUFFINGS[this._stuffing].price);
  ...
  get calculateCalories() {
    let calories = this._toppings.map(i => Hamburger.TOPPINGS[i].calories);
    calories.push(Hamburger.SIZES[this._size].calories, Hamburger.STUFFINGS[this._stuffing].calories);
    calories = calories.reduce((acc, i) => acc + i, 0)
    return calories
  }
}
...
// log(hamburger._toppings)
// log(hamburger._size)
// log(hamburger._stuffing)
// log(hamburger.calculatePrice)
